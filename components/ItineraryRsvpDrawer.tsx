...
import ItineraryRsvpModal from "@/components/ItineraryRsvpModal";
...
export default function ItineraryRsvpDrawer() {
  ...
  return (
    <>
      ...
      <ItineraryRsvpModal open={rsvpOpen} onClose={() => setRsvpOpen(false)} />
    </>
  );
}
